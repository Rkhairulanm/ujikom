        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown" style="height: 50px">
                    <a class="nav-link dropdown-toggle {{ $title == 'Transaksi' ? 'active' : '' }}" href="#"
                        role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-chart-simple"
                                style="color: {{ $title == 'Transaksi' ? '#ffffff' : '#111111' }};"></i>
                        </div>
                        <span class="nav-link-text ms-1">Transaksi</span>
                    </a>
                    <ul class="dropdown-menu position-absolute" style="margin-left: 13px;"
