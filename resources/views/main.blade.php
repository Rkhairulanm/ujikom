    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title == 'Produk' ? 'active' : '' }}" href="/barang">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <a class="nav-link {{ $title == 'Detail Penjualan' ? 'active' : '' }}" href="/penjualan"
                        ...
                        <div
                            ...
                            <i class="fa-solid fa-bag-shopping"
                                style="color: {{ $title == 'Detail Penjualan' ? '#ffffff' : '#111111' }};"></i>
                        </div>
                        <span class="nav-link-text ms-1">Detail Penjualan</span>
                    </a>
                </li>
                <li class="nav-item dropdown" style="height: 50px">
                    <a class="nav-link {{ $title == 'Riwayat Transaksi' ? 'active' : '' }}" href="/history"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-receipt"
                                style="color: {{ $title == 'Riwayat Transaksi' ? '#ffffff' : '#111111' }};"></i>
                        </div>
                        <span class="nav-link-text ms-1">Riwayat Transaksi</span>
                    </a>
                </li>
                <li class="nav-item dropdown" style="height: 50px">
                    <a class="nav-link {{ $title == 'Pelanggan' ? 'active' : '' }}" href="/pelanggan" role="button"
                        aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item dropdown" style="height: 50px">
                    <a class="nav-link {{ $title == 'Log' ? 'active' : '' }}" href="/Log" role="button"
                        aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-history"
                                style="color: {{ $title == 'Log' ? '#ffffff' : '#111111' }};"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title == 'Pembelian' ? 'active' : '' }}" href="/pembelian">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="sidenav-footer mx-3 mt-4 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                ...
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        <h6 class="text-white up mb-3">Hi {{ Auth::user()->name }}</h6>

                        <p class="text-xs font-weight-bold">Start To Manage Your Business</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown d-flex align-items-center">
                            <a class="nav-link dropdown-toggle text-body font-weight-bold px-0" href="#"
                                ...
                                @if (Auth::check())
                                    <i class="fas fa-store me-sm-1"></i>
